...
form.addEventListener("submit", (e) => {
    ...
    let newPerson = {
        ...
        bookurl: document.getElementById("rasm").value,
...
const showEditModal = (id) => {
    ...
    document.getElementById("rasm2").value = person.bookimage
}
...
form2.addEventListener("submit", (e) => {
    ...
    let newData = data?.map((item) => {
        if (item.id == editId) {
            item.bookName = document.getElementById("nom").value
            item.bookauthor = document.getElementById("muallif").value
            item.bookyear = Number(document.getElementById("yil").value)
            item.bookName = document.getElementById("nom").value
            item.bookName = document.getElementById("link").value
            item.bookimage = document.getElementById("rasm2").value
        }
    ...
    let newPerson = {
        ...
        bookyear: Number(document.getElementById("yil").value),
        bookurl: document.getElementById("link").value,
        bookimage: document.getElementById("rasm2").value,
    }
